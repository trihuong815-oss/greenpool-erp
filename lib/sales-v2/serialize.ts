...
export function serializeTransaction(id: string, raw: Record<string, any>): SalesTransaction {
  return {
    ...
    basePackageValue: raw.basePackageValue != null ? Number(raw.basePackageValue) : undefined,
    discountAmount: raw.discountAmount != null ? Number(raw.discountAmount) : 0,
    bonusQuantity: raw.bonusQuantity != null ? Number(raw.bonusQuantity) : 0,
    bonusDays: raw.bonusDays != null ? Number(raw.bonusDays) : 0,
