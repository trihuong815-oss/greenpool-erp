...
export const MENU_PERMISSIONS: Record<string, string[]> = {
  ...
  ADMIN:     ['dashboard','doanh-so','doanh-so/nhap','doanh-so/packages','checklist-v2','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','quan-ly-sale','sodo','luong','bao-cao','daotao','mkt','users','ky-thuat','cong-viec-ca-nhan'],
  CEO:       ['dashboard','doanh-so','doanh-so/nhap','doanh-so/packages','checklist-v2','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','quan-ly-sale','sodo','luong','bao-cao','daotao','mkt','users','ky-thuat','cong-viec-ca-nhan'],
  GD_KD:     ['dashboard','doanh-so','doanh-so/nhap','doanh-so/packages','checklist-v2','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','quan-ly-sale','sodo','luong','bao-cao','daotao','mkt','users','ky-thuat','cong-viec-ca-nhan'],
  GD_VP:     ['dashboard',         'checklist-v2','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','quan-ly-sale','sodo','luong','bao-cao','ky-thuat','cong-viec-ca-nhan'],

  // QLCS_* — KHÔNG thấy `luong`, `doanh-so/packages` (quản trị gói catalog), `users` (theo spec 2026-05-27)
  QLCS_HM:   ['dashboard','doanh-so','doanh-so/nhap','checklist-v2','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','sodo','bao-cao','daotao','mkt','ky-thuat','cong-viec-ca-nhan'],
  QLCS_TK:   ['dashboard','doanh-so','doanh-so/nhap','checklist-v2','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','sodo','bao-cao','daotao','mkt','ky-thuat','cong-viec-ca-nhan'],
  QLCS_CTT:  ['dashboard','doanh-so','doanh-so/nhap','checklist-v2','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','sodo','bao-cao','daotao','mkt','ky-thuat','cong-viec-ca-nhan'],
  QLCS_24NCT:['dashboard','doanh-so','doanh-so/nhap','checklist-v2','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','sodo','bao-cao','daotao','mkt','ky-thuat','cong-viec-ca-nhan'],
  QLCS_TT:   ['dashboard','doanh-so','doanh-so/nhap','checklist-v2','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','sodo','bao-cao','daotao','mkt','ky-thuat','cong-viec-ca-nhan'],

  TP_KT:     ['dashboard','checklist-v2','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','bao-cao','ky-thuat','cong-viec-ca-nhan'],
  // Phó phòng KT (Hệ thống / Xử lý nước) — xem toàn module ky-thuat, không xem doanh số.
  PP_HT:     ['dashboard','checklist-v2','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','bao-cao','ky-thuat','cong-viec-ca-nhan'],
  PP_XLN:    ['dashboard','checklist-v2','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','bao-cao','ky-thuat','cong-viec-ca-nhan'],
  ...
  KT_HT_HM:    ['dashboard','giao-viec','de-xuat','ky-thuat'],
  KT_HT_TK:    ['dashboard','giao-viec','de-xuat','ky-thuat'],
  KT_HT_CTT:   ['dashboard','giao-viec','de-xuat','ky-thuat'],
  KT_HT_24NCT: ['dashboard','giao-viec','de-xuat','ky-thuat'],
  KT_HT_TT:    ['dashboard','giao-viec','de-xuat','ky-thuat'],
  KT_XLN_HM:    ['dashboard','giao-viec','de-xuat','ky-thuat'],
  KT_XLN_TK:    ['dashboard','giao-viec','de-xuat','ky-thuat'],
  KT_XLN_CTT:   ['dashboard','giao-viec','de-xuat','ky-thuat'],
  KT_XLN_24NCT: ['dashboard','giao-viec','de-xuat','ky-thuat'],
  KT_XLN_TT:    ['dashboard','giao-viec','de-xuat','ky-thuat'],
  TP_DT:     ['dashboard','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','bao-cao','daotao','cong-viec-ca-nhan'],
  TP_MKT:    ['dashboard','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','bao-cao','mkt','cong-viec-ca-nhan'],
  TIBAN_TT:  ['dashboard','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','bao-cao','cong-viec-ca-nhan'],
  TP_GS:     ['dashboard','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','bao-cao','sodo','cong-viec-ca-nhan'],
  TP_KE:     ['dashboard','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','bao-cao','luong','cong-viec-ca-nhan'],
  TP_NS:     ['dashboard','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','bao-cao','luong','sodo','cong-viec-ca-nhan'],

  TT_DT:     ['dashboard','quy-trinh','giao-viec','de-xuat','quan-ly-cong-viec','bao-cao'],
  GV_CB:     ['dashboard','quy-trinh','giao-viec','de-xuat'],
  GV_NC:     ['dashboard','quy-trinh','giao-viec','de-xuat'],
  NV_SALE:   ['dashboard','giao-viec','de-xuat'],
  NV_CH:     ['dashboard','giao-viec','de-xuat'],
};
