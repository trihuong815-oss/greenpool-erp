...
export const MENU_PERMISSIONS: Record<string, string[]> = {
  ...
  KT_HT_TK:    ['dashboard','checklist','giao-viec','ky-thuat'],
  KT_HT_CTT:   ['dashboard','checklist','giao-viec','ky-thuat'],
  KT_HT_24NCT: ['dashboard','checklist','giao-viec','ky-thuat'],
  KT_HT_TT:    ['dashboard','checklist','giao-viec','ky-thuat'],
  KT_XLN_HM:    ['dashboard','checklist','giao-viec','ky-thuat'],
  KT_XLN_TK:    ['dashboard','checklist','giao-viec','ky-thuat'],
  KT_XLN_CTT:   ['dashboard','checklist','giao-viec','ky-thuat'],
  KT_XLN_24NCT: ['dashboard','checklist','giao-viec','ky-thuat'],
  KT_XLN_TT:    ['dashboard','checklist','giao-viec','ky-thuat'],
  TP_DT:     ['dashboard','checklist','quy-trinh','giao-viec','quan-ly-cong-viec','bao-cao','daotao','cong-viec-ca-nhan'],
  TP_MKT:    ['dashboard','checklist','quy-trinh','giao-viec','quan-ly-cong-viec','bao-cao','mkt','cong-viec-ca-nhan'],
  TIBAN_TT:  ['dashboard','checklist','quy-trinh','giao-viec','quan-ly-cong-viec','bao-cao','cong-viec-ca-nhan'],
  TP_GS:     ['dashboard','checklist','quy-trinh','giao-viec','quan-ly-cong-viec','bao-cao','sodo','cong-viec-ca-nhan'],
  TP_KE:     ['dashboard','checklist','quy-trinh','giao-viec','quan-ly-cong-viec','bao-cao','luong','cong-viec-ca-nhan'],
  TP_NS:     ['dashboard','checklist','quy-trinh','giao-viec','quan-ly-cong-viec','bao-cao','luong','sodo','cong-viec-ca-nhan'],

  TT_DT:     ['dashboard','checklist','quy-trinh','giao-viec','quan-ly-cong-viec','bao-cao'],
