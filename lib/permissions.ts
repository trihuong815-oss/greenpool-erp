...
export const MENU_PERMISSIONS: Record<string, string[]> = {
  ...
  // PR-CASH1D (2026-06-23): wire route 'bao-cao-thu-chi' — THU_QUY xem read-only toàn hệ thống.
  THU_QUY:   ['dashboard','tin-nhan','bao-cao-thu-chi','cong-viec-ca-nhan','bao-mat','thong-bao'],
